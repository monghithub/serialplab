...
|---|---|---|---|
| `service-springboot` | Java 21 + Spring Boot 3 | 11001 | [service-springboot.md](service-springboot.md) |
| `service-quarkus` | Java 21 + Quarkus | 11002 | [service-quarkus.md](service-quarkus.md) |
| `service-go` | Go 1.22+ | 11003 | [service-go.md](service-go.md) |
| `service-node` | Node.js 22 + Express/Fastify | 11004 | [service-node.md](service-node.md) |
